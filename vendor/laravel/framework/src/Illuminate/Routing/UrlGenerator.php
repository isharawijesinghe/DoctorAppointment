...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    /**
     * Generate a URL to an application admin.
     *
     * @param  string  $path
     * @param  bool|null  $secure
     * @return string
    ...
    public function asset($path, $secure = null)
    {
        ...
        // for admin paths, but only for routes to endpoints in the application.
    ...
    /**
     * Generate a URL to an admin from a custom root domain such as CDN, etc.
     *
     * @param  string  $root
     * @param  string  $path
     * @param  bool|null  $secure
    ...
    /**
     * Generate a URL to a secure admin.
     *
     * @param  string  $path
     * @return string
     */
