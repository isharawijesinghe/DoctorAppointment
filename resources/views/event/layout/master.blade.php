...
<head>
    ...
    <link rel="icon" href="{{ url('/admin/calander') }}/_asset/favicon.png">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/admin/calander') }}">{{ config('app.name') }}</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="{{ route('event/list') }}">Events List</a></li>
